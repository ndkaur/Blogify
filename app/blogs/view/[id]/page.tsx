...
const BlogViewPage = async ({params}: {params: {id: string}}) => {
  ...
  return (
    // <div>BlogViewPage {JSON.stringify(blog)}</div>
    <section className="w-full h-full felx flex-col">
      ...
      <div className="md:w-2/4 xs:w-3/4 mx-auto my-8 ">
        <h2 className="md:text-6xl  text-center">{blog.title}</h2>
      </div>
      <section className="md:w-2/4 xs:w-3/4 mx-auto my-8" dangerouslySetInnerHTML={{__html:blog.description}}>
