    ...
    <section className="w-full h-full flex flex-col">
        <div className="mx-auto rounded-xl bg-slate-200 my-10 px-10 py-5">
            ...
            <div className="flex flex-col">
                ...
                <button onClick={handleSubmit(signInWithCreds)} className="my-2 font-bold broder-[1px] bg-slate-100 px-6 py-3 flex items-center justify-center rounded-xl gap-3 duration-300">
                    Login{" "}
